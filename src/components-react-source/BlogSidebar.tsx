  ...
  return (
    <aside className="lg:w-[30%]">
      <div className="lg:sticky lg:top-28 space-y-8">
        ...
        {/* Book CTA */}
        <Link to="/book" className="group block bg-background rounded-xl shadow-sm border border-border/60 p-6 text-center hover:border-primary/40 transition-colors">
          <img
            src={bookCover}
        ...
        <div className="bg-background rounded-xl shadow-sm border border-border/60 p-6">
          ...
          <ul className="space-y-4">
            ...
            <li>
              <Link
                to="/resources/blog/google-business-profile-tips"
                className="group block"
              >
