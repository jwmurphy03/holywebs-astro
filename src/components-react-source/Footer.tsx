      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mt-14 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link to="/privacy-policy" className="text-sm text-white/40 hover:text-primary transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-sm text-white/40 hover:text-primary transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
