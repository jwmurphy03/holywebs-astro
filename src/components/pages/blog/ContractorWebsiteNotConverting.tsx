          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-[70%]">
              <article className="blog-article">
                ...
                <p>
                  Speed isn't just a user experience issue. It's a <a href="/services/seo" className="text-primary">ranking factor</a>. Google explicitly uses Core Web Vitals as part of its algorithm. A slow site loses twice: once to bouncing visitors, and once to lower search&nbsp;rankings.
                </p>
                <blockquote>
                  <p>
                ...
                <blockquote>
                  <p>
                    <strong>The fix:</strong> Open your website on your own phone right now. Try to complete every action a customer would take. If anything feels clunky, slow, or frustrating, it needs to be rebuilt with a <a href="/services/web-design" className="text-primary">mobile-first approach</a>.
                  </p>
                </blockquote>
                ...
                <ol>
                  ...
                  <li><strong>Check your Google Business Profile.</strong> Does your <a href="/services/google-business-profile" className="text-primary">GBP listing</a> link to the correct page on your&nbsp;website?</li>
                </ol>
                <p>
                ...
                <p>
                  For a deeper look at what your website should include, read our full <a href="/resources/website-guide-service-businesses" className="text-primary">Website Guide for Local Service&nbsp;Businesses</a>.
                </p>
              ...
              <div className="mt-6 text-center">
                <p className="text-muted-foreground text-sm">
                  ...
                  <a href="/workshop" className="text-primary underline decoration-2 decoration-[#ecec13] hover:bg-[#ecec13] hover:text-foreground transition-colors font-medium">
                    Reserve your spot
                  </a>
                </p>
              </div>
