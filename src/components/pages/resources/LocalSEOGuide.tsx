          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 max-w-6xl mx-auto">
            ...
            <article className="flex-1 min-w-0 max-w-3xl">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                ...
                <a href="/services/seo" className="text-primary font-semibold hover:underline">SEO services page</a>.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                ...
                <a href="/services/google-business-profile" className="text-primary font-semibold hover:underline">Google Business Profile management service</a>.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                ...
                <a href="/locations" className="text-primary font-semibold hover:underline">location pages</a>{" "}
