...
import heroImg from "@/assets/guide-hero-website.jpg";
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 max-w-6xl mx-auto">
            ...
            <article className="flex-1 min-w-0 max-w-3xl">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                ...
                <a href="/services/web-design" className="text-primary font-semibold hover:underline">professional web design services</a>&nbsp;page.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                ...
                <a href="/locations" className="text-primary font-semibold hover:underline">locations hub</a>, where we've built individual city pages for each market we serve, each one optimized for local search visibility in that specific&nbsp;area.
              </p>
