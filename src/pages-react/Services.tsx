    ...
    <Layout>
      ...
      <SectionWrapper variant="light">
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((s) => (
            <Link key={s.title} to={s.to} className="group bg-background rounded-xl p-8 border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300">
