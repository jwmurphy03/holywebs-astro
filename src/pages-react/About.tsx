    ...
    <Layout>
      ...
      <section className="section-dark py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold text-dark-foreground mb-6">About Holy&nbsp;Webs</h1>
      ...
      <SectionWrapper variant="light">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-8">
            <Link to="/industries" className="inline-flex items-center gap-2 text-primary font-semibold hover:text-primary/80 transition-colors">
      ...
      <SectionWrapper variant="light">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-xl mx-auto">
            <Link to="/locations/texas/houston" className="bg-background rounded-xl p-6 border border-border hover:border-primary/30 hover:shadow-md transition-all group">
            ...
            <Link to="/locations/south-carolina/charleston" className="bg-background rounded-xl p-6 border border-border hover:border-primary/30 hover:shadow-md transition-all group">
              <Award className="w-8 h-8 text-primary mx-auto mb-3" />
